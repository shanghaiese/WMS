...
import {detailsOrderService} from '../service/detailsOrderService'
@Component({
    templateUrl: './app/detailsOrder/components/detailsOrder.html'
})
export class DetailsOrderComponent implements OnInit {
    ...
    constructor(private detailsOrderService: detailsOrderService) {
        ...
        this.detailsOrderService.getSpecifiedOrder('po/100').then(resp=> {
