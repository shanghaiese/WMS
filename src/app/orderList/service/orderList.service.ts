/**
 * Created by caikaijie on 2016/11/29.
 */
...
export class OrderListService {
    private headers = new Headers({'Content-Type': 'application/json'});//Access-Control-Request-Method: DELETE


    constructor(private http: Http) { }
    //获取订单列表
    getOrderList(url: string): Promise<any> {
