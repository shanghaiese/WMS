...
import { editOrderService} from '../service/editOrderService';
...
@Component({
    ...
    templateUrl: './app/editOrder/components/editOrder.html',

})
export class EditOrderComponent{
    private gridOptions: GridOptions;//申明gridOptions配置项
    detailsOrderDataObject={
        "owner":{},
        "supplier":{}
    };
    details=[];
    ...
    constructor(private editOrderService: editOrderService) {
        ...
        this.gridOptions.rowData = EditOrderInitData;
        this.gridOptions.columnDefs = this.createColumnDefs();
        agrid = this.gridOptions;
        this.editOrderService.getSpecifiedOrder('asn/100').then(resp=> {
            console.log(resp.obj);
            this.detailsOrderDataObject = resp.obj;//获取后台返回的Form中信息
    ...
    private  add2(name: string): void {
        //
        //if (!name) { return; }
        //this.formService.getAsnList(name)
        //    .then(resp => {
        //       console.log(resp);
    }
